...
/// TomTom-only polyline matching (independent of HERE/Mapbox implementations).
class TomTomPolylineMatchingOptions {
  const TomTomPolylineMatchingOptions({
  ...
  TomTomPolylineMatchingOptions withEdgeMph(List<int?>? edgeMph) => TomTomPolylineMatchingOptions(
  ...
  factory TomTomPolylineMatchingOptions.fromPosition(Position p) {
    final h = p.accuracy;
    final ha = p.headingAccuracy;
    final spd = p.speed;
    return TomTomPolylineMatchingOptions(
...
/// Cross-track distance, along-polyline distance, and projection helpers for TomTom Snap geometry.
///
...
class TomTomCrossTrackGeometry {
  TomTomCrossTrackGeometry._();
  ...
  static TomTomPolylineProjection? projectOntoPolylineDetailed(
    double userLat,
    double userLng,
    List<GeoCoordinate> geometry,
  ) =>
  ...
  static TomTomPolylineProjection? projectOntoPolylineForMatching(
    double userLat,
    double userLng,
    List<GeoCoordinate> geometry,
    double? userHeadingDeg, {
    TomTomPolylineMatchingOptions? matchingOptions,
  }) {
    ...
    final brg = bearingDeg(a.lat, a.lng, b.lat, b.lng);
    return TomTomPolylineProjection(
...
class TomTomPolylineProjection {
  TomTomPolylineProjection({
