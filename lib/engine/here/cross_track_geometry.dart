...
/// HERE-only polyline matching (no shared types with other providers).
class HerePolylineMatchingOptions {
  const HerePolylineMatchingOptions({
  ...
  HerePolylineMatchingOptions withEdgeMph(List<int?>? edgeMph) => HerePolylineMatchingOptions(
  ...
  factory HerePolylineMatchingOptions.fromPosition(Position p) {
    final h = p.accuracy;
    final ha = p.headingAccuracy;
    final spd = p.speed;
    return HerePolylineMatchingOptions(
...
/// Cross-track distance, along-polyline distance, and projection helpers for HERE route geometry.
///
...
class HereCrossTrackGeometry {
  HereCrossTrackGeometry._();
  ...
  static HerePolylineProjection? projectOntoPolylineDetailed(
    double userLat,
    double userLng,
    List<GeoCoordinate> geometry,
  ) =>
  ...
  static HerePolylineProjection? projectOntoPolylineForMatching(
    double userLat,
    double userLng,
    List<GeoCoordinate> geometry,
    double? userHeadingDeg, {
    HerePolylineMatchingOptions? matchingOptions,
  }) {
...
class HerePolylineProjection {
  HerePolylineProjection({
